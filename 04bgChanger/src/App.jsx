...
// onClick needs a function, not the function's value so don't call a function inside it. Instead give it a function. Here, although setColor is a function but it is enclosed inside another function to give it to onClick
  return (
